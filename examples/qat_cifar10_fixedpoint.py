"""
CIFAR-10 QAT with Brevitas using Fixed-Point Weight Quantization — small MobileNet-style CNN.
...
Run
---
    python examples/qat_cifar10_fixedpoint.py
    python examples/qat_cifar10_fixedpoint.py --weight-bits 4 --act-bits 4 \\
                               --workdir ./runs/cifar10_fixedpoint_4bit
"""
...
from models.cifar10_fixedpoint_quant import QuantMobileNetCIFAR
...
def main(args):
    ...
    # Mirroring the hardcoded path from examples/qat_cifar10.py
    pretrained_path = "/home/th/tmp/quanttests/cifar10_vgg_float/checkpoints/best_float.pt"
