...
class YOLOv8nPANOnly(nn.Module):
    ...
    def __init__(self, nc: int = 80, weight_quant=None, act_quant=None, weight_bit_width: int = 8, act_bit_width: int = 8):
        ...
        self.b0  = Conv(3,  C1, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)
        self.b1  = Conv(C1, C2, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)
        self.b2  = C2f(C2, C2, n=scale_depth(3), shortcut=True, weight_quant=weight_quant, act_quant=act_quant)
        self.b3  = Conv(C2, C3, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)
        self.b4  = C2f(C3, C3, n=scale_depth(6), shortcut=True, weight_quant=weight_quant, act_quant=act_quant)   # → P3
        self.b5  = Conv(C3, C4, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)
        self.b6  = C2f(C4, C4, n=scale_depth(6), shortcut=True, weight_quant=weight_quant, act_quant=act_quant)   # → P4
        self.b7  = Conv(C4, C5, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)
        self.b8  = C2f(C5, C5, n=scale_depth(3), shortcut=True, weight_quant=weight_quant, act_quant=act_quant)
        self.b9  = SPPF(C5, C5, k=5, weight_quant=weight_quant, act_quant=act_quant)                              # → P5

        # ---- Neck: bottom-up only ----
        # P3 → downsample → concat P4 → C2f
        self.n16 = Conv(C3, C3, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)           # C3 → C3
        self.n18 = C2f(C3 + C4, C4, n=scale_depth(3), shortcut=False, weight_quant=weight_quant, act_quant=act_quant)  # P4_out

        # P4_out → downsample → concat P5 → C2f
        self.n19 = Conv(C4, C4, k=3, s=2, weight_quant=weight_quant, act_quant=act_quant)           # C4 → C4
        self.n21 = C2f(C4 + C5, C5, n=scale_depth(3), shortcut=False, weight_quant=weight_quant, act_quant=act_quant)  # P5_out
